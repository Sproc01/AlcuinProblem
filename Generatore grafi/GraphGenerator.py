...
#pseudo-casuale, in modo tale da permettere la riproduci- bilita` degli esperimenti.
...
#comportamento pseudo-casuale della generazione, permettendo la replicabilit`a dell’esperimento.
...
#permettendo cosi' la replicabilit`a dell’esperimento.
