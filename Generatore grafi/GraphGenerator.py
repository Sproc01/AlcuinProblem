...
file=open("Grafi/gnp_random.txt","a")
file.write("\n!"+str(c))
file.close()
...
file=open("Grafi/random_regular.txt","a")
file.write("\n!"+str(c))
file.close()
...
file=open("Grafi/watts_strogatz.txt","a")
file.write("\n!"+str(c))
file.close()
...
file=open("Grafi/barbasi_albert.txt","a")
file.write("\n!"+str(c))
file.close()
